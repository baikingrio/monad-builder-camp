export default defineNuxtConfig({
  ...
  runtimeConfig: {
    // Server-only Sponsor signer secret. It is intentionally not public runtime config.
    sponsorPrivateKey: '',
    // Local/dev-only private gate. NUXT_SPONSOR_SIGNING_ENABLED must be explicitly true.
